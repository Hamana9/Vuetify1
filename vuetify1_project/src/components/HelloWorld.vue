    ...
    return {
      ...
      featuredJobs: [
        // ... (existing featured jobs data)
        {
          ...
          logo: 'logos/play-burger-king-png-logo-2.PNG',
        },
        {
          id: 2,
          title: 'Dish Washer',
          ...
          logo: 'logos/mcdonald-s-transparent-mcdonald-s-free-free-png.PNG',
        },
        {
        id: 3,
        ...
        logo: 'logos/ac-mainstage-logo_800x336.PNG',
      },
      {
        id: 4,
        title: 'Lifeguard',
      ...
      },
      {
        ...
        logo: 'logos/3ff7946878d698155218eaff2dc6138c.PNG',
      },
      ],
      popularJobs: [
